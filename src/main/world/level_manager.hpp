...
inline constexpr double kInfiniteCollectorStartDensityMultiplier = 1.0;
inline constexpr double kInfiniteCollectorDensityGrowthPerLevel = 0.3;
...
inline constexpr float kInfiniteCollectorInitialTimerMin = 0.0f;
inline constexpr float kInfiniteCollectorInitialTimerMax = 0.5f;
